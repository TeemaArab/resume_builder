...
const EducationForm = ({data, onChange}) => {
  ...
  return (
    <div>
        ...
        {/* right side */}
        <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 
       ...
       {data.length=== 0 ?(
        <div className='text-center py-8 text-gray-500'>
           <GraduationCap className='w-12 h-12 mx-auto mb-3
            ...
            <p className='text-sm'>Click "Add your education details.</p>
        </div>
          ):(
